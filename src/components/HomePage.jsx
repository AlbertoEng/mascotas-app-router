                ...
                <div className="row gap-3 d-flex justify-content-center">
                    {
                        selector === 'especie' && listaMascotas.map((mascota) => {
                            return mascota.especie === especie ? <div key={mascota.key} className="card p-0 col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3" style={{ width: '18rem' }}>
                    ...
                    }
                    {
                        (selector === 'especie' && !especie ) && listaMascotas.map((mascota) => {
                            return <div key={mascota.key} className="card p-0 col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3" style={{ width: '18rem' }}>
                                <img src={mascota.foto} className="card-img-top h-50" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">{mascota.nombre}</h5>
                                    <p className="card-text">{mascota.genero}</p>
                    ...
                    {
                        (selector === 'raza' && raza !== "" ) && listaMascotas.map((mascota) => {
                            return mascota.raza.toLowerCase().includes( raza.toLowerCase() ) ? <div key={mascota.key} className="card p-0 col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3" style={{ width: '18rem' }}>
                                <img src={mascota.foto} className="card-img-top h-50" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">{mascota.nombre}</h5>
                                    <p className="card-text">{mascota.genero}</p>
